...
root.resizable(0,0)
root.title("RESTORAN KAMI") # nama aplikasi

topFrame=Frame(root,bd=10,relief=RIDGE,bg='white') # frame judul
topFrame.pack(side=TOP)

labelTitle=Label(topFrame,text='RESTORAN KAMI',font=('Castellar',39,'bold'),fg='#fde4c3',bg='#302a18', bd=15,width=30) #judul aplikasi
...
brunchFrame=LabelFrame(menuFrame,text=' Makanan ',font=('Castellar',19,'bold'),bd=10,relief=RIDGE,fg='#2f2f2f', bg='#f6f6f6')
...
LabelHargadariBrunch=Label(hargaFrame,text='    HARGA DARI MAKANAN', font=('Constantia',12,'bold'),bg='#050206',fg='#fde4c3')
